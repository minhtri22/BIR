...
PROJECT_TRANSITIONS: tuple[ProjectTransition, ...] = (
    ...
    ProjectTransition(
        ...
        "Analysis job fails or is cancelled before review begins.",
        recovery_rule="Return to recorded previous stable state; default to ready_for_analysis.",
    ),
    ProjectTransition(
        "analyzing",
        "review_in_progress",
        ...
        "fail_or_cancel_analysis",
        "ANALYSIS_FAILED_OR_CANCELLED",
        "Analysis job fails or is cancelled during re-analysis from review.",
        recovery_rule="Return to recorded previous stable state.",
    ),
    ProjectTransition(
        "analyzing",
        ...
        "fail_or_cancel_analysis",
        "ANALYSIS_FAILED_OR_CANCELLED",
        "Analysis job fails or is cancelled during re-analysis from export readiness.",
        recovery_rule="Return to recorded previous stable state.",
    ),
    ProjectTransition(
        "review_in_progress",
